...
public class redtest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traj10 = drive.trajectoryBuilder(new Pose2d(-29, 0, Math.toRadians(0)))
                .forward(55)
                .build();
        Trajectory traj11 = drive.trajectoryBuilder(new Pose2d(26, 0, Math.toRadians(-90)))
                .forward(15)
                .build();
        Trajectory traj12 = drive.trajectoryBuilder(new Pose2d(26, -15, Math.toRadians(-90)))
                .forward(6)
                .build();
        Trajectory traj13 = drive.trajectoryBuilder(new Pose2d(26, -21, Math.toRadians(-90)))
                .back(20)
                .build();
        Trajectory traj14 = drive.trajectoryBuilder(new Pose2d(26, -1, Math.toRadians(-180)))
                .forward(60)
                .build();
        Trajectory traj15 = drive.trajectoryBuilder(new Pose2d(-34, -1, Math.toRadians(-180)))
                .forward(5)
                .build();
