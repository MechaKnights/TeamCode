...
@Autonomous
public class aaRedDuckdet extends LinearOpMode {
    OpenCvWebcam webcam;
    ...
    private Servo push;
    private Servo sword1;
    private Servo sword2;
    ...
    public void runOpMode() {
        ...
        sword1 = hardwareMap.get(Servo.class, "sword1");
        sword2 = hardwareMap.get(Servo.class, "sword2");
        telemetry.update();
        ...
        while (opModeIsActive()) {
            ...
            lift.setPower(.1);
            push.setPosition(1);
            sword2.setPosition(1);
            sword1.setPosition(0);
